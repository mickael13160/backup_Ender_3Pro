...
config_folder=~/printer_1_data/config
...
# mdb_load -f ~/printer_1_data/config/data.mdb.backup -s -T ~/printer_1_data/database/

if command -v /usr/bin/mdb_dump &> /dev/null
then
    if $history_only
    then
        echo "mdb_dump found! Exporting history table from data.mdb to ~/printer_1_data/config/data.mdb.backup"
        mdb_dump -s history -n ~/printer_1_data/database/data.mdb -f ~/printer_1_data/config/data.mdb.backup
    else
        echo "mdb_dump found! Exporting ALL tables data.mdb to ~/printer_1_data/config/data.mdb.backup"
        mdb_dump -a -n ~/printer_1_data/database/data.mdb -f ~/printer_1_data/config/data.mdb.backup
    fi
else
